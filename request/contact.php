...
if ($post) {
    ...
    if (!$error) {
        ...
        $subject = "Новая заявка с сайта ddboard.kz";
        ...
        */
        ...
        $header.= "From: Новая заявка <87053811230s@gmail.com>\n\n";
        $mail = mail("87053811230s@gmail.com", $subject1, iconv('utf-8', 'windows-1251', $message1), iconv('utf-8', 'windows-1251', $header));
