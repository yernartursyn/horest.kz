...
$(".fly").click(function () {
  // когда нажимаем 2 раз открывается корзина
  if (this.classList.contains("into_basket")) {
    $.jqCart("openCart");
    toastr[""]("success"); // don't show notification
    // $("#toast-container")[0].classList.add("not_notif");
  }
...
$(".fly").click(function () {
  ...
  toastr["success"]("<img class=\"notif_gal\" src=\"/images/galochka.png\"><span>\u0422\u043E\u0432\u0430\u0440 \u0434\u043E\u0431\u0430\u0432\u043B\u0435\u043D \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443</span><button type=\"button\"><img class=\"toast-close-button\" src=\"/images/x.png\"></button>");
});